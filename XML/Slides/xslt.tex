...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Empty transformation}
\label{empty.xsl}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Empty transformation (cont)}
\label{cookbook.xml}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Matching (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Applying several templates (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Selecting children to be matched}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Selecting children to be matched (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/From \XML to \XHTML}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/From \XML to \XHTML (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/From \XML to \XHTML{}/Example}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/From \XML to \XHTML{}/Example (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Conditionals (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Template parameters}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Template parameters (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Selecting nodes}
\label{menu}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Using wildcards}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Inserting elements (cont)}
\label{cars}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Named templates}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XSLT/Named templates (cont)}
