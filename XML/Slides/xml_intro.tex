...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Repeated nodes (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Attributes (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Predefined named entities (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/User-defined internal entities and document type declarations (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Unparsed entities and notations (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/A summary of all kinds of entities}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Internal linking}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Internal linking (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Namespaces/Unbinding the default namespace}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Namespaces/More name scoping}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Namespaces (cont)}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Checking the well-formedness}
...
% ------------------------------------------------------------------------
%
\begin{frame}{XML/Checking the well-formedness (cont)}
