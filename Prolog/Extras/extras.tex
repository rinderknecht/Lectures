...
blue).
\vfill
\centering\includegraphics[bb=71 605 258 732]{four_layers}
...
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
    \begin{center}
      \includegraphics[bb=64 640 248 730, scale=0.85]{thresholds_xor}
    \end{center}
\end{columns}
...
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
    \begin{center}
      \includegraphics[bb=65 612 236 725, scale=0.935]{xor}
    \end{center}
...
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
    \begin{center}
      \includegraphics[bb=60 612 236 725, scale=0.935]{xor_opp_biases}
    \end{center}
...
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
  \begin{center}
    \includegraphics[bb=65 646 155 726]{single-node}
  \end{center}
...
\begin{columns}[c]
  ...
  \begin{center}
    \includegraphics[bb=47 660 160 730]{xor_conf}
  \end{center}
...
\begin{columns}[t]
  ...
  \column{0.5\textwidth}
    Node \(H_1\) mapping:
    \begin{center}
      \includegraphics[bb=45 660 158 730, scale=0.9]{h1_mapping}
    \end{center}

  \column{0.5\textwidth}
    Node \(H_2\) mapping:
    \begin{center}
      \includegraphics[bb=42 660 153 730, scale=0.9]{h2_mapping}
    \end{center}
...
way.
\begin{center}
  \includegraphics[bb=40 660 390 730, scale=0.935]{hidden_layer_mapping}
\end{center}
\begin{columns}[c]
  ...
  \column{0.5\textwidth}
  \begin{center}
    \includegraphics[bb=45 648 218 730,scale=0.935]{output_layer_mapping}
  \end{center}
...
weights and bias.
\begin{center}
\includegraphics[bb=65 613 235 725]{incomplete_xor}
\end{center}
