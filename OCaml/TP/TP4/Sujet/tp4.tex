...
Un arbre binaire est un arbre où chaque nœud a au plus deux fils, un
fils gauche et un fils droit. De plus, chaque nœud est annoté par une
...
une recherche sera la hauteur de l'arbre, soit $O(\log n)$ si l'arbre
est équilibré.
